...
### Background
- To increase user retention, in addition to in-store scanning (location data collection), provide additional content for users.
- Verification of location data re-collection and data research.
  <br>
  <br>
### Responsibilities
- Android: Design and develop check-in feature (100%)
- Server (GCP App Engine / Python 2.7): Design and develop check-in feature API (100%)
- Database (MySQL): Design and develop (100%)
  <br>
  <br>
### Architecture
